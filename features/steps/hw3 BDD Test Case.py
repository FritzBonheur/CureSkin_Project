...
def verify_elements_are_present(context, expected_results):
    actual_result = context.driver.find_element(By.XPATH, "//h1[@class='a-spacing-small']").text
    assert expected_results == actual_result, f'Error! Expected {expected_results} bot got actual {actual_result}'
